...
const DATABASE_URL = process.env.DATABASE_URL ?? "postgres://cim:cim@localhost:5432/cim";
 ...
 */
export function latestEmailLinkFor(toEmail: string, kind: "verify_email" | "password_reset"): string {
