 ...
 * executive_summary/risk/opportunity are P2 report-builder kinds
 * (docs/product/FEATURE_MATRIX.md), the column stays text so adding them
 * is a data change, not a migration (same convention as alertRules.type).
 */
