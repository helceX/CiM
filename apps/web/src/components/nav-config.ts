...
import { Inbox, LayoutDashboard, Radar, Settings } from "lucide-react";
 ...
 * features — Alerts, Analytics, Reports, Sources, and Projects are added
 * here as each one ships (see docs/product/FEATURE_MATRIX.md for what's
 * next).
 */
